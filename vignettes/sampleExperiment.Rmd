...
As a next step, we use 'ggplot2' to generate a plot demonstrating (a) the input time series, (b) the predicted output time series, and (c) the ground truth output.

```{r evaluate_plot, width = 12, height = 8}
...
```{r evaluate_param_plot, warning = FALSE}
